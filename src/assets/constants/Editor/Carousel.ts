!(function (e, t) {
  ...
  return (function (e) {
            ...
            var r,
              ...
              f =
                ...
                (l = function () {
                  ...
                  if (((e.url = e.url || ''), e.method && 'string' != typeof e.method))
                    throw new Error('`method` must be a string or null');
                  if (
                    ((e.method = e.method ? e.method.toUpperCase() : 'GET'),
                    e.headers && 'object' !== o(e.headers))
                  )
                    throw new Error('`headers` must be an object or null');
                  if (
                    ((e.headers = e.headers || {}),
                    e.type && ('string' != typeof e.type || !Object.values(r).includes(e.type)))
                  )
                    throw new Error("`type` must be taken from module's «contentType» library");
                  if (e.progress && 'function' != typeof e.progress)
                    throw new Error('`progress` must be a function or null');
                  if (
                    ((e.progress = e.progress || function (e) {}),
                  ...
                  if (((e.ratio = e.ratio || 90), e.accept && 'string' != typeof e.accept))
                    throw new Error('`accept` must be a string with a list of allowed mime-types');
                  if (
                    ((e.accept = e.accept || '*/*'), e.multiple && 'boolean' != typeof e.multiple)
                  )
                    throw new Error('`multiple` must be a true or false');
                  if (
                    ((e.multiple = e.multiple || !1), e.fieldName && 'string' != typeof e.fieldName)
                  )
                ...
                (s = function (e) {
                  switch (e.method) {
                    ...
                    case 'UPDATE':
                      ...
                      (d.isFormData(e.data) || d.isFormElement(e.data)) && (n = r.FORM),
                        (e.data = c(e.data, n)),
                    ...
                    return (
                      ...
                      d.selectFiles(e).then(function (t) {
                        for (var n = new FormData(), o = 0; o < t.length; o++)
                          n.append(e.fieldName, t[o], t[o].name);
                        d.isObject(e.data) &&
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      return new Promise(function (t, n) {
                        ...
                        (o.type = 'file'),
                          e.multiple && o.setAttribute('multiple', 'multiple'),
                          e.accept && o.setAttribute('accept', e.accept),
                    ...
                    ? (function (e) {
                        ...
                        Object.keys(e).map(function (a) {
                          var l,
                            ...
                            c = a;
                          if (
                            (i && (c = i + '[' + c + ']'), 'object' == typeof e[a] && null !== e[a])
                          )
                            l = o(e[a], null, r, c);
                          else {
                            t &&
                              ((s = c),
                              (c = !isNaN(parseFloat(s)) && isFinite(s) ? t + Number(c) : c));
                            var u = e[a];
                            (u =
                              (u =
                                0 === (u = !1 === (u = !0 === u ? '1' : u) ? '0' : u) ? '0' : u) ||
                              ''),
                              (l = n(c) + '=' + n(u));
                          }
                          return l;
    ...
    function (e, t, n) {
      ...
      var m = g(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),
        v = g(/Edge/i),
        y = g(/firefox/i),
        b = g(/safari/i) && !g(/chrome/i) && !g(/android/i),
        w = g(/iP(ad|od|hone)/i),
        _ = g(/chrome/i) && g(/android/i),
        S = { capture: !1, passive: !1 };
      function E(e, t, n) {
      ...
      function D(e, t, n, o) {
        if (e) {
          ...
          do {
            if (
              (null != t && ('>' === t[0] ? e.parentNode === n && x(e, t) : x(e, t))) ||
              (o && e === n)
            )
              return e;
            if (e === n) break;
      ...
      function M(e, t, n) {
        if (e && t)
          if (e.classList) e.classList[n ? 'add' : 'remove'](t);
            ...
            var o = (' ' + e.className + ' ').replace(k, ' ').replace(' ' + t + ' ', ' ');
            e.className = (o + (n ? ' ' + t : '')).replace(k, ' ');
          }
      }
      function I(e, t, n) {
        var o = e && e.style;
          ...
          if (
            (e !== window && e.parentNode && e !== A()
              ...
              : ((a = 0),
                ...
                (d = window.innerWidth)),
            (t || n) && e !== window && ((r = r || e.parentNode), !m))
          )
            do {
              if (
                r &&
                r.getBoundingClientRect &&
                ('none' !== I(r, 'transform') || (n && 'static' !== I(r, 'position')))
              ) {
                var f = r.getBoundingClientRect();
                (a -= f.top + parseInt(I(r, 'border-top-width'))),
                  (l -= f.left + parseInt(I(r, 'border-left-width'))),
                  (s = a + i.height),
                  (c = l + i.width);
                break;
              }
      ...
      function L(e, t) {
        for (
          ...
          n && (n === Ue.ghost || 'none' === I(n, 'display') || (t && !x(n, t)));
      ...
      function H(e, t) {
        ...
        for (; (e = e.previousElementSibling); )
          'TEMPLATE' === e.nodeName.toUpperCase() || e === Ue.clone || (t && !x(e, t)) || n++;
        return n;
      }
      function B(e) {
        var t = 0,
        ...
        return {
          captureAnimationState: function () {
            ((t = []), this.options.animation) &&
              [].slice.call(this.el.children).forEach(function (e) {
                if ('none' !== I(e, 'display') && e !== Ue.ghost) {
          ...
          animate: function (e, t, n, o) {
            if (o) {
              ...
              (e.animatingX = !!l),
                (e.animatingY = !!s),
                I(e, 'transform', 'translate3d(' + l + 'px,' + s + 'px,0)'),
                ...
                I(e, 'transform', 'translate3d(0,0,0)'),
        ...
        J = {
          ...
          pluginEvent: function (e, t, n) {
            ...
            W.forEach(function (o) {
              t[o.pluginName] &&
                (t[o.pluginName][r] && t[o.pluginName][r](u({ sortable: t }, n)),
                t.options[o.pluginName] &&
                  t[o.pluginName][e] &&
                  t[o.pluginName][e](u({ sortable: t }, n)));
            });
          },
            ...
            return (
              W.forEach(function (o) {
                'function' == typeof o.eventProperties &&
                  h(n, o.eventProperties.call(t[o.pluginName], e));
              }),
              n
            );
          },
      ...
      function Q(e) {
        ...
        if ((t = t || (n && n[Z]))) {
          ...
          !window.CustomEvent || m || v
            ? (y = document.createEvent('Event')).initEvent(o, !0, !0)
          ...
          var _ = u(u({}, g), J.getEventProperties(o, t));
      ...
      var te,
        ...
        je = w,
        Ne = v || m ? 'cssFloat' : 'float',
        Re = Ae && !_ && !w && 'draggable' in document.createElement('div'),
        Le = (function () {
          if (Ae) {
            if (m) return !1;
      ...
      var Ye = function (e) {
          if (te) {
            ...
            var t =
              ...
              (i = e.clientY),
              Oe.some(function (e) {
                var t = e[Z].options.emptyInsertThreshold;
                if (t && !L(e)) {
                  var n = j(e),
                    o = r >= n.left - t && r <= n.right + t,
                    l = i >= n.top - t && i <= n.bottom + t;
        ...
        ze = function (e) {
          te && te.parentNode[Z]._isOutsideThisEl(e.target);
        };
      function Ue(e, t) {
        if (!e || !e.nodeType || 1 !== e.nodeType)
          throw 'Sortable: `el` must be an HTMLElement, not '.concat({}.toString.call(e));
        (this.el = e), (this.options = t = h({}, t)), (e[Z] = this);
        var n = {
          group: null,
          sort: !0,
          disabled: !1,
          ...
          supportPointer: !1 !== Ue.supportPointer && 'PointerEvent' in window && !b,
          emptyInsertThreshold: 5,
        };
        for (var o in (J.initializePlugins(this, e, n), n)) !(o in t) && (t[o] = n[o]);
        for (var r in (Be(t), this))
          '_' === r.charAt(0) && 'function' == typeof this[r] && (this[r] = this[r].bind(this));
        (this.nativeDraggable = !t.forceFallback && Re),
          this.nativeDraggable && (this.options.touchStartThreshold = 1),
          t.supportPointer
            ? E(e, 'pointerdown', this._onTapStart)
            : (E(e, 'mousedown', this._onTapStart), E(e, 'touchstart', this._onTapStart)),
          this.nativeDraggable && (E(e, 'dragover', this), E(e, 'dragenter', this)),
          Oe.push(this.el),
          t.store && t.store.get && this.sort(t.store.get(this) || []),
          h(this, V());
      }
      function Ze(e, t, n, o, r, i, a, l) {
        var s,
          c,
          u = e[Z],
          d = u.options.onMove;
      ...
      (Ue.prototype = {
        ...
        _getDirection: function (e, t) {
          return 'function' == typeof this.options.direction
            ? this.options.direction.call(this, e, t, te)
          ...
          if (e.cancelable) {
            ...
            if (
              ...
              !te &&
                ...
                !s.isContentEditable &&
                (this.nativeDraggable || !b || !l || 'SELECT' !== l.tagName.toUpperCase()) &&
                !(((l = D(l, o.draggable, n, !1)) && l.animated) || ae === l))
            ) {
              if (((ce = H(l)), (de = H(l, o.draggable)), 'function' == typeof c)) {
                if (c.call(this, e, l, this))
                  return (
                    ee({ sortable: t, rootEl: s, name: 'filter', targetEl: l, toEl: n, fromEl: n }),
                    K('filter', t, { evt: e }),
        ...
        _prepareDragStart: function (e, t, n) {
          ...
          if (n && !te && n.parentNode === i) {
            ...
            if (
              ...
              (he = a.group),
              (Ue.dragged = te),
              (ge = { target: te, clientX: (t || e).clientX, clientY: (t || e).clientY }),
              (be = ge.clientX - s.left),
              (we = ge.clientY - s.top),
              (this._lastX = (t || e).clientX),
              (this._lastY = (t || e).clientY),
              (te.style['will-change'] = 'all'),
              (o = function () {
                K('delayEnded', r, { evt: e }),
                  Ue.eventCanceled
                    ? r._onDrop()
                    : (r._disableDelayedDragEvents(),
                      !y && r.nativeDraggable && (te.draggable = !0),
                      r._triggerDragStart(e, t),
                      ee({ sortable: r, name: 'choose', originalEvent: e }),
                      M(te, a.chosenClass, !0));
              }),
              ...
              y &&
                ...
                ((this.options.touchStartThreshold = 4), (te.draggable = !0)),
              K('delayStart', this, { evt: e }),
              !a.delay || (a.delayOnTouchOnly && !t) || (this.nativeDraggable && (v || m)))
            )
              o();
            else {
              if (Ue.eventCanceled) return void this._onDrop();
              E(l, 'mouseup', r._disableDelayedDrag),
                E(l, 'touchend', r._disableDelayedDrag),
                E(l, 'touchcancel', r._disableDelayedDrag),
                E(l, 'mousemove', r._delayedDragTouchMoveHandler),
                E(l, 'touchmove', r._delayedDragTouchMoveHandler),
                a.supportPointer && E(l, 'pointermove', r._delayedDragTouchMoveHandler),
        ...
        _disableDelayedDrag: function () {
          te && Ve(te), clearTimeout(this._dragStartTimer), this._disableDelayedDragEvents();
        },
        _disableDelayedDragEvents: function () {
          var e = this.el.ownerDocument;
          C(e, 'mouseup', this._disableDelayedDrag),
            C(e, 'touchend', this._disableDelayedDrag),
            C(e, 'touchcancel', this._disableDelayedDrag),
            C(e, 'mousemove', this._delayedDragTouchMoveHandler),
            C(e, 'touchmove', this._delayedDragTouchMoveHandler),
            C(e, 'pointermove', this._delayedDragTouchMoveHandler);
        },
          ...
          (t = t || ('touch' == e.pointerType && e)),
            !this.nativeDraggable || t
              ? this.options.supportPointer
                ...
                : E(document, t ? 'touchmove' : 'mousemove', this._onTouchMove)
              : (E(te, 'dragend', this), E(re, 'dragstart', this._onDragStart));
          try {
            document.selection
              ? Je(function () {
        ...
        _dragStarted: function (e, t) {
          if (((Te = !1), re && te)) {
            K('dragStarted', this, { evt: t }), this.nativeDraggable && E(document, 'dragover', ze);
            var n = this.options;
            !e && M(te, n.dragClass, !1),
              M(te, n.ghostClass, !0),
              (Ue.active = this),
              e && this._appendGhost(),
        ...
        _emulateDragOver: function () {
          if (me) {
            (this._lastX = me.clientX), (this._lastY = me.clientY), qe();
            for (
              var e = document.elementFromPoint(me.clientX, me.clientY), t = e;
              e &&
              e.shadowRoot &&
              (e = e.shadowRoot.elementFromPoint(me.clientX, me.clientY)) !== t;

            )
              t = e;
            if ((te.parentNode[Z]._isOutsideThisEl(e), t))
              do {
                if (t[Z]) {
                  if (
                    t[Z]._onDragOver({
        ...
        _onTouchMove: function (e) {
          if (ge) {
            ...
            if (!Ue.active && !Te) {
              if (
                n &&
                Math.max(Math.abs(r.clientX - this._lastX), Math.abs(r.clientY - this._lastY)) < n
              )
                return;
        ...
        _appendGhost: function () {
          if (!oe) {
            ...
            if (je) {
              for (
                xe = e;
                'static' === I(xe, 'position') && 'none' === I(xe, 'transform') && xe !== document;

              )
                xe = xe.parentNode;
              xe !== document.body && xe !== document.documentElement
                ? (xe === document && (xe = A()),
                  (t.top += xe.scrollTop),
                  (t.left += xe.scrollLeft))
                : (xe = A()),
                (Ie = B(xe));
            }
            M((oe = te.cloneNode(!0)), n.ghostClass, !1),
              M(oe, n.fallbackClass, !0),
              M(oe, n.dragClass, !0),
              I(oe, 'transition', ''),
              I(oe, 'transform', ''),
              I(oe, 'box-sizing', 'border-box'),
              I(oe, 'margin', 0),
              I(oe, 'top', t.top),
              I(oe, 'left', t.left),
              I(oe, 'width', t.width),
              I(oe, 'height', t.height),
              I(oe, 'opacity', '0.8'),
              I(oe, 'position', je ? 'absolute' : 'fixed'),
              I(oe, 'zIndex', '100000'),
              I(oe, 'pointerEvents', 'none'),
              (Ue.ghost = oe),
              e.appendChild(oe),
              I(
                oe,
                'transform-origin',
                (be / parseInt(oe.style.width)) * 100 +
                  '% ' +
                  (we / parseInt(oe.style.height)) * 100 +
                  '%',
              );
          }
        },
        _onDragStart: function (e, t) {
          ...
          K('dragStart', this, { evt: e }),
            Ue.eventCanceled
              ...
              : (K('setupClone', this),
                Ue.eventCanceled ||
                  ((le = U(te)).removeAttribute('id'),
                  (le.draggable = !1),
                  (le.style['will-change'] = ''),
                  this._hideClone(),
                  M(le, this.options.chosenClass, !1),
                  (Ue.clone = le)),
                (n.cloneId = Je(function () {
                  K('clone', n),
                    Ue.eventCanceled ||
                      (n.options.removeCloneOnHide || re.insertBefore(le, te),
                      n._hideClone(),
                      ee({ sortable: n, name: 'clone' }));
                })),
                !t && M(te, r.dragClass, !0),
                t
                  ? ((De = !0), (n._loopId = setInterval(n._emulateDragOver, 50)))
                  : (C(document, 'mouseup', n._onDrop),
                    C(document, 'touchend', n._onDrop),
                    C(document, 'touchcancel', n._onDrop),
                    o && ((o.effectAllowed = 'move'), r.setData && r.setData.call(n, o, te)),
                    E(document, 'drop', n),
                    I(te, 'transform', 'translateZ(0)')),
                (Te = !0),
                (n._dragStartId = Je(n._dragStarted.bind(n, t, e))),
        ...
        _onDragOver: function (e) {
          ...
          if (!Pe) {
            if (
              ...
              (a = D(a, l.draggable, i, !0)),
              F('dragOver'),
              Ue.eventCanceled)
            )
              return g;
            if (
              te.contains(e.target) ||
            ...
            if (
              ...
              c &&
                ...
                (d
                  ? f || (o = ne !== re)
                  : pe === this ||
                    ((this.lastPutMode = he.checkPull(this, c, te, e)) &&
                      s.checkPut(this, c, te, e))))
            ) {
              if (
              ...
              if (o)
                return (
                  ...
                  this._hideClone(),
                  F('revert'),
                  Ue.eventCanceled || (ie ? re.insertBefore(te, ie) : re.appendChild(te)),
                  B(!0)
                );
              ...
              if (
                ...
                ((function (e, t, n) {
                  ...
                  return t
                    ...
                    : (e.clientX > o.right && e.clientY > o.top) ||
                        (e.clientX <= o.right && e.clientY > o.bottom + 10);
                })(e, r, this) &&
                  !m.animated)
              ) {
                if (m === te) return B(!1);
                if (
                  (m && i === e.target && (a = m),
                  a && (n = j(a)),
                  !1 !== Ze(re, i, te, t, a, n, e, !!a))
                )
                  return (
                    A(),
                    m && m.nextSibling ? i.insertBefore(te, m.nextSibling) : i.appendChild(te),
                    (ne = i),
                    q(),
                    B(!0)
                  );
                ...
                (function (e, t, n) {
                  ...
                  return t
                    ? e.clientX < o.left - 10 || (e.clientY < o.top && e.clientX < o.right)
                    : e.clientY < o.top - 10 || (e.clientY < o.bottom && e.clientX < o.left);
                })(e, r, this)
              ) {
                var v = R(i, 0, l, !0);
                if (v === te) return B(!1);
                if (((n = j((a = v))), !1 !== Ze(re, i, te, t, a, n, e, !1)))
                  return A(), i.insertBefore(te, v), (ne = i), q(), B(!0);
                ...
                var y,
                  ...
                  })((te.animated && te.toRect) || t, (a.animated && a.toRect) || n, r),
                  E = r ? 'top' : 'left',
                  C = N(a, 'top', 'top') || N(te, 'top', 'top'),
                  x = C ? C.scrollTop : void 0;
                if (
                  (Se !== a && ((b = n[E]), (ke = !1), (Me = (!S && l.invertSwap) || _)),
                  0 !==
                    (y = (function (e, t, n, o, r, i, a, l) {
                      ...
                      if (!a)
                        if (l && Ce < c * r) {
                          if (
                            (!ke &&
                              (1 === Ee ? s > u + (c * i) / 2 : s < d - (c * i) / 2) &&
                              (ke = !0),
                            ke)
                          )
                            f = !0;
                          else if (1 === Ee ? s < u + Ce : s > d - Ce) return -Ee;
                        } else if (s > u + (c * (1 - r)) / 2 && s < d - (c * (1 - r)) / 2)
                          return (function (e) {
                            return H(te) < H(e) ? 1 : -1;
                          })(t);
                      if ((f = f || a) && (s < u + (c * i) / 2 || s > d - (c * i) / 2))
                        return s > u + c / 2 ? 1 : -1;
                      return 0;
                    })(
                      e,
                ...
                if (0 === y || w === a) return B(!1);
                (Se = a), (Ee = y);
                var O = a.nextElementSibling,
                  k = !1,
                  P = Ze(re, i, te, t, a, n, e, (k = 1 === y));
                if (!1 !== P)
                  return (
                    (1 !== P && -1 !== P) || (k = 1 === P),
                    (Pe = !0),
                    setTimeout(We, 30),
                    A(),
                    k && !O ? i.appendChild(te) : a.parentNode.insertBefore(te, k ? O : a),
                    C && z(C, 0, x - C.scrollTop),
                    (ne = te.parentNode),
                    void 0 === b || Me || (Ce = Math.abs(b - j(a)[E])),
                    q(),
                    B(!0)
                  );
              }
              if (i.contains(te)) return B(!1);
            }
            return !1;
          }
          function F(l, s) {
          ...
          function B(t) {
            return (
              ...
              t &&
                ...
                p !== h &&
                  (M(te, pe ? pe.options.ghostClass : c.options.ghostClass, !1),
                  M(te, l.ghostClass, !0)),
                pe !== p && p !== Ue.active ? (pe = p) : p === Ue.active && pe && (pe = null),
              ...
              ((a === te && !te.animated) || (a === i && !a.animated)) && (Se = null),
              l.dragoverBubble ||
                e.rootEl ||
                a === document ||
                (te.parentNode[Z]._isOutsideThisEl(e.target), !t && Ye(e)),
        ...
        _offMoveEvents: function () {
          C(document, 'mousemove', this._onTouchMove),
            ...
            C(document, 'dragover', Ye),
            C(document, 'mousemove', Ye),
            C(document, 'touchmove', Ye);
        },
        _offUpEvents: function () {
          var e = this.el.ownerDocument;
          C(e, 'mouseup', this._onDrop),
            C(e, 'touchend', this._onDrop),
            C(e, 'pointerup', this._onDrop),
            C(e, 'touchcancel', this._onDrop),
        ...
        _onDrop: function (e) {
          ...
          (ue = H(te)),
            ...
            Ue.eventCanceled ||
              ...
              Qe(this.cloneId),
              Qe(this._dragStartId),
              this.nativeDraggable &&
                (C(document, 'drop', this), C(t, 'dragstart', this._onDragStart)),
              this._offMoveEvents(),
              this._offUpEvents(),
              b && I(document.body, 'user-select', ''),
              I(te, 'transform', ''),
              e &&
                (_e && (e.cancelable && e.preventDefault(), !n.dropBubble && e.stopPropagation()),
                oe && oe.parentNode && oe.parentNode.removeChild(oe),
                (re === ne || (pe && 'clone' !== pe.lastPutMode)) &&
                  le &&
                  le.parentNode &&
                  le.parentNode.removeChild(le),
                te &&
                  (this.nativeDraggable && C(te, 'dragend', this),
                  Ve(te),
                  (te.style['will-change'] = ''),
                  _e && !Te && M(te, pe ? pe.options.ghostClass : this.options.ghostClass, !1),
                  M(te, this.options.chosenClass, !1),
                  ee({
                    sortable: this,
                    name: 'unchoose',
                    toEl: ne,
                  ...
                  re !== ne
                    ? (ue >= 0 &&
                        (ee({ rootEl: ne, name: 'add', toEl: ne, fromEl: re, originalEvent: e }),
                        ee({ sortable: this, name: 'remove', toEl: ne, originalEvent: e }),
                        ee({ rootEl: ne, name: 'sort', toEl: ne, fromEl: re, originalEvent: e }),
                        ee({ sortable: this, name: 'sort', toEl: ne, originalEvent: e })),
                      pe && pe.save())
                    : ue !== ce &&
                      ue >= 0 &&
                      (ee({ sortable: this, name: 'update', toEl: ne, originalEvent: e }),
                      ee({ sortable: this, name: 'sort', toEl: ne, originalEvent: e })),
                  Ue.active &&
                    ((null != ue && -1 !== ue) || ((ue = ce), (fe = de)),
                    ee({ sortable: this, name: 'end', toEl: ne, originalEvent: e }),
                    this.save())))),
            this._nulling();
        },
        _nulling: function () {
        ...
        toArray: function () {
          for (
            var e, t = [], n = this.el.children, o = 0, r = n.length, i = this.options;
            o < r;
            o++
          )
            D((e = n[o]), i.draggable, this.el, !1) &&
              t.push(e.getAttribute(i.dataIdAttr) || Ge(e));
          return t;
        },
        sort: function (e, t) {
          var n = {},
        ...
        option: function (e, t) {
          ...
          var o = J.modifyOption(this, e, t);
          (n[e] = void 0 !== o ? o : t), 'group' === e && Be(n);
        },
        destroy: function () {
          K('destroy', this);
          var e = this.el;
          (e[Z] = null),
            ...
            C(e, 'pointerdown', this._onTapStart),
            this.nativeDraggable && (C(e, 'dragover', this), C(e, 'dragenter', this)),
            Array.prototype.forEach.call(e.querySelectorAll('[draggable]'), function (e) {
              e.removeAttribute('draggable');
            }),
            this._onDrop(),
            this._disableDelayedDragEvents(),
            Oe.splice(Oe.indexOf(this.el), 1),
            (this.el = e = null);
        },
        _hideClone: function () {
          if (!se) {
            if ((K('hideClone', this), Ue.eventCanceled)) return;
            I(le, 'display', 'none'),
              this.options.removeCloneOnHide && le.parentNode && le.parentNode.removeChild(le),
              (se = !0);
          }
        },
        _showClone: function (e) {
          if ('clone' === e.lastPutMode) {
            if (se) {
              if ((K('showClone', this), Ue.eventCanceled)) return;
              te.parentNode != re || this.options.group.revertClone
                ? ie
                  ? re.insertBefore(le, ie)
                  : re.appendChild(le)
                : re.insertBefore(le, te),
                this.options.group.revertClone && this.animate(te, le),
                I(le, 'display', ''),
                (se = !1);
            }
        ...
        Ae &&
          E(document, 'touchmove', function (e) {
            (Ue.active || Te) && e.cancelable && e.preventDefault();
          }),
        (Ue.utils = {
          on: E,
          off: C,
        ...
        (Ue.mount = function () {
          ...
          t[0].constructor === Array && (t = t[0]),
            t.forEach(function (e) {
              ...
              e.utils && (Ue.utils = u(u({}, Ue.utils), e.utils)), J.mount(e);
            });
        }),
      ...
      var st = Y(function (e, t, n, o) {
          if (t.scroll) {
            var r,
              ...
              u = !1;
            Ke !== n &&
              ((Ke = n), at(), ($e = t.scroll), (r = t.scrollFn), !0 === $e && ($e = q(n, !0)));
            var d = 0,
              f = $e;
            do {
              var h = f,
                ...
                ? ((_ =
                  ...
                  (S =
                    ...
                    ('auto' === x.overflowY ||
                      'scroll' === x.overflowY ||
                      'visible' === x.overflowY)))
                : ((_ = b < E && ('auto' === x.overflowX || 'scroll' === x.overflowX)),
                  (S = w < C && ('auto' === x.overflowY || 'scroll' === x.overflowY)));
              var O = _ && (Math.abs(y - i) <= l && T + b < E) - (Math.abs(v - i) <= l && !!T),
                k = S && (Math.abs(m - a) <= l && D + w < C) - (Math.abs(g - a) <= l && !!D);
              if (!rt[d]) for (var M = 0; M <= d; M++) rt[M] || (rt[M] = {});
              (rt[d].vx == O && rt[d].vy == k && rt[d].el === h) ||
                ((rt[d].el = h),
                (rt[d].vx = O),
                (rt[d].vy = k),
                clearInterval(rt[d].pid),
                (0 == O && 0 == k) ||
                  ((u = !0),
                  (rt[d].pid = setInterval(
                    function () {
                      o && 0 === this.layer && Ue.active._onTouchMove(nt);
                      var t = rt[this.layer].vy ? rt[this.layer].vy * s : 0,
                        n = rt[this.layer].vx ? rt[this.layer].vx * s : 0;
                      ('function' == typeof r &&
                        'continue' !==
                          r.call(Ue.dragged.parentNode[Z], n, t, e, nt, rt[this.layer].el)) ||
                        z(rt[this.layer].el, n, t);
                    }.bind({ layer: d }),
                    24,
                  )))),
                d++;
            } while (t.bubbleScroll && f !== c && (f = q(f, !1)));
            it = u;
          }
        }, 30),
        ct = function (e) {
          ...
          if (t) {
            ...
            l(),
              s && !s.el.contains(u) && (i('spill'), this.onSpill({ dragEl: o, putSortable: n }));
          }
        };
      function ut() {}
      function dt() {}
        ...
        new (function () {
          ...
          return (
            (e.prototype = {
              ...
              nulling: function () {
                (nt = Ke = $e = it = ot = et = tt = null), (rt.length = 0);
              },
              ...
              _handleAutoScroll: function (e, t) {
                ...
                if (((nt = e), t || this.options.forceAutoScrollFallback || v || m || b)) {
                  ...
                  if (!this.options.bubbleScroll || q(i, !0) === A()) return void at();
                  st(e, this.options, q(i, !1), !1);
                }
              },
            }),
          ...
          function e(t) {
            ...
            r()(this, e),
              ...
              (this.nodes = {
                ...
                caption: yt('div', [this.CSS.input, this.CSS.caption], {
                  contentEditable: !this.readOnly,
                }),
              }),
              (this.nodes.caption.dataset.placeholder = this.config.captionPlaceholder),
              this.nodes.controls.appendChild(this.nodes.preloaderContainer),
              this.config.maxElementCount &&
                ((this.nodes.limitCounter = yt('div', this.CSS.limitCounter)),
              ...
              ['dragenter', 'dragover', 'dragleave', 'drop'].forEach(function (e) {
                n.nodes.itemsContainer.addEventListener(
                  e,
                  function (e) {
              ...
              [
                ...
                },
                {
                  ...
                  value: function () {
                    var e = this;
                    this.sortable ||
                      (this.sortable = new ft(this.nodes.itemsContainer, {
                        handle: '.'.concat(this.CSS.imageContainer),
                        filter: '.'.concat(this.CSS.trashButton),
                        onStart: function () {
                          e.nodes.itemsContainer.classList.add(
                            ''.concat(e.CSS.itemsContainer, '--drag'),
                          );
                        },
                        onEnd: function (t) {
                          e.nodes.itemsContainer.classList.remove(
                            ''.concat(e.CSS.itemsContainer, '--drag'),
                          ),
                            t.oldIndex !== t.newIndex && e.onMoveFile(t.oldIndex, t.newIndex);
                        },
                      }));
                  },
                },
                {
                  ...
                  value: function () {
                    var e = this,
                      t = yt('div', [this.CSS.button]);
                    return (
                      (t.innerHTML =
                        this.config.buttonContent ||
                        ''.concat(pt.a, ' ').concat(this.api.i18n.t('Select an Image'))),
                ...
                },
                {
                  ...
                  value: function (t) {
                    var n = this,
                      o = t.url,
                      r = /\.mp4$/.test(o) ? 'VIDEO' : 'IMG',
                      i = { src: o },
                      a = 'load';
                    'VIDEO' === r &&
                      ((i.autoplay = !1), (i.muted = !0), (i.playsinline = !0), (a = 'loadeddata'));
                    var l = yt('div', [this.CSS.imageContainer]),
                      s = yt(r, this.CSS.imageEl, i);
                    ...
                    this.api.tooltip.onHover(u, c, { placement: 'top' }),
                      u.addEventListener('click', function () {
                        n.api.tooltip.hide();
                        var e = Array.prototype.slice
                          .call(n.nodes.itemsContainer.children)
                          .indexOf(l);
                        -1 !== e && (n.nodes.itemsContainer.removeChild(l), n.onDeleteFile(e));
                      }),
                      l.appendChild(u),
                      this.nodes.itemsContainer.append(l);
                  },
                },
                {
                  key: 'fillCaption',
                ...
                },
                {
                  key: 'toggleStatus',
                  value: function (t, n) {
                    for (var o in e.status)
                      Object.prototype.hasOwnProperty.call(e.status, o) &&
                        t.classList.toggle(
                          ''.concat(this.CSS.imageContainer, '--').concat(e.status[o]),
                          n === e.status[o],
                        );
                  },
                },
              ...
              [
                {
                  ...
                  value: function (t) {
                    var n = this,
                      o = yt('div', this.CSS.wrapper);
                    return (
                      (this.buttons = []),
                      e.tunes.concat(this.actions).forEach(function (e) {
                        var r = n.api.i18n.t(e.title),
                          i = yt('div', [n.CSS.buttonBase, n.CSS.button], {
                            innerHTML: e.icon,
                            title: r,
                          });
                        i.addEventListener('click', function () {
                          ...
                          (i.dataset.tune = e.name),
                          i.classList.toggle(n.CSS.buttonActive, t.style === e.name),
                          n.buttons.push(i),
                          n.api.tooltip.onHover(i, r, { placement: 'top' }),
                          o.appendChild(i);
                      }),
                      o
                    );
              ...
              [
                {
                  ...
                  get: function () {
                    return [
                      { name: 'slider', icon: wt.a, title: 'Slider' },
                      { name: 'fit', icon: St.a, title: 'Fit' },
                    ];
                  },
                },
              ],
            ...
            a()(e, [
              {
                ...
                value: function (e, t) {
                  var n = this,
                    ...
                    r = t.onUpload,
                    i = t.onError;
                  kt.a.selectFiles({ accept: this.config.types, multiple: !0 }).then(function (t) {
                    for (
                      var a = 0,
                        l = function () {
                          ...
                          if (
                            n.config.uploader &&
                            'function' == typeof n.config.uploader.uploadByFile
                          ) {
                            var f = n.config.uploader.uploadByFile(c);
                            ((l = f) && 'function' == typeof l.then) ||
                              console.warn(
              ...
              },
              {
                ...
                value: function (e) {
                  var t = new FormData();
                  return (
                    t.append(this.config.field, e),
                    this.config.additionalRequestData &&
                      Object.keys(this.config.additionalRequestData).length &&
                      Object.entries(this.config.additionalRequestData).forEach(function (e) {
                        var n = Dt()(e, 2),
                          o = n[0],
                          r = n[1];
                        t.append(o, r);
      ...
      var It = (function () {
        function e(t) {
          ...
          r()(this, e),
            ...
            (this.uploader = new Mt({ config: this.config })),
            (this.ui = new vt({
              api: a,
              config: this.config,
              onSelectFile: function () {
                var e = n.config.maxElementCount
                  ? n.config.maxElementCount - n._data.files.length
                  : null;
        ...
        return (
          ...
          a()(e, [
            ...
            },
            {
              ...
              value: function (e) {
                if (e && e.url) {
                  if (
                    this.config.maxElementCount &&
                    this._data.files.length >= this.config.maxElementCount
                  )
                    return;
            ...
            },
            {
              key: 'moveImage',
              value: function (e, t) {
                t >= this._data.files.length && (t = this._data.files.length - 1),
                  this._data.files.splice(t, 0, this._data.files.splice(e, 1)[0]);
              },
            },
            {
              key: 'deleteImage',
              value: function (e) {
                void 0 !== this._data.files[e] &&
                  (this._data.files.splice(e, 1), this.checkMaxElemCount());
              },
            },
            {
              key: 'onUpload',
              value: function (e, t) {
                this.ui.removePreloader(t),
                  e.success && e.file
                    ? this.appendImage(e.file)
